...
moto_render_node_init(MotoRenderNode *self)
{
    ...
    moto_node_add_params(node,
        ...
        "size", "Width/Height", MOTO_TYPE_INT2, MOTO_PARAM_MODE_INOUT, size, NULL, "Arguments",
        // "skip_untouched",  "Skip Untouched", MOTO_TYPE_BOOL, MOTO_PARAM_MODE_INOUT, TRUE, NULL, "Optimization",
        NULL);
}
